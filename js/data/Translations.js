...
const Translations = {
	...
	fr: {
		...
		'tag.cristal_field.label':           'Champ de Cristal',
		'tag.mankarog.label':                'Mankarog',
		...
		'tag.quad_predator.label':           'Chasseurs du sommet',
		'tag.quad_intelligent.label':        'Monde natal',
		...
		'tag.quad_seismic_activity.label':   'Ligne de faille',
		'tag.quad_volcanic_activity.label':  'Une expédition sympa',

		// Planet tags — descriptions
		'tag.oxygen.desc':                   'Contient un secteur Oxygène.',
		'tag.cristal_field.desc':            'Contient un secteur Champ de Cristal.',
		...
		'tag.varied_landscape.desc':         'Terrain très varié.',
		...
		'tag.no_astro.desc':                 'Principalement non scanné.',
	...
	es: {
		...
		'tag.quad_wreck.label':              'El Gran Cementerio de Chatarra',
