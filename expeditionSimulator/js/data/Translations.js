...
const Translations = {
	...
	en: {
		...
		// Patch notes
		'patch_notes.v1_4.subtitle_crew':    'Crew Manager',
		'patch_notes.v1_4.crew1':            'Improved expert mode with global modifiers that can be applied to all crew members at once.',
		'patch_notes.v1_4.crew2':            'Added a new day button (-1 morale, +1 health for all living crew members).',
		'patch_notes.v1_4.crew3':            'Added a death button (-1 morale for all living crew members).',
		'patch_notes.v1_4.crew4':            'Changed the starting morale to 6 instead of 14.',
		'patch_notes.v1_4.crew5':            'Fixed the crew manager import not importing mush skills.',
		'patch_notes.v1_4.crew6':            'Improved the mush skill selection modal, grouping skills like the wiki does.',
		'patch_notes.v1_4.subtitle_project': 'Project Manager',
		'patch_notes.v1_4.project1':         'Added the Project Manager module.',
		'patch_notes.v1_4.subtitle_general': 'General',
		'patch_notes.v1_4.general1':         'Fixed the extension not loading properly in some cases.',
		'patch_notes.v1_4.general2':         'Added a way to reorder panels in the settings.',
		'patch_notes.v1_4.general3':         'Hiding a module now also hides its related import buttons.',
		'patch_notes.v1_4.general4':         'Fixed the tab not closing properly.',
		'patch_notes.v1_4.general5':         'Fixed import buttons sometimes slipping onto the wrong, unrelated message.',
	...
	fr: {
		...
		// Patch notes
		'patch_notes.v1_4.subtitle_crew':    'Gestion d\'équipage',
		'patch_notes.v1_4.crew1':            'Amélioration du mode expert avec des modificateurs globaux applicables à tout l\'équipage en une fois.',
		'patch_notes.v1_4.crew2':            'Ajout d\'un bouton nouveau jour (-1 moral, +1 santé pour tous les membres d\'équipage vivants).',
		'patch_notes.v1_4.crew3':            'Ajout d\'un bouton de décès (-1 moral pour tous les membres d\'équipage vivants).',
		'patch_notes.v1_4.crew4':            'Changement du moral de départ à 6 au lieu de 14.',
		'patch_notes.v1_4.crew5':            'Correction de l\'import de l\'équipage qui n\'importait pas les compétences mush.',
		'patch_notes.v1_4.crew6':            'Amélioration de la fenêtre de sélection des compétences mush, regroupées comme sur le wiki.',
		'patch_notes.v1_4.subtitle_project': 'Gestion de projets',
		'patch_notes.v1_4.project1':         'Ajout du module de gestion de projets.',
		'patch_notes.v1_4.subtitle_general': 'Général',
		'patch_notes.v1_4.general1':         'Correction de l\'extension qui ne se chargeait pas correctement dans certains cas.',
		'patch_notes.v1_4.general2':         'Ajout d\'un moyen de réordonner les panneaux dans les réglages.',
		'patch_notes.v1_4.general3':         'Masquer un module masque maintenant aussi ses boutons d\'import associés.',
		'patch_notes.v1_4.general4':         'Correction de l\'onglet qui ne se fermait pas correctement.',
		'patch_notes.v1_4.general5':         'Correction des boutons d\'import qui se retrouvaient parfois sur le mauvais message, sans rapport.',
	...
	es: {
		...
		// Patch notes
		'patch_notes.v1_4.subtitle_crew':    'Gestor de tripulación',
		'patch_notes.v1_4.crew1':            'Mejorado el modo experto con modificadores globales aplicables a toda la tripulación a la vez.',
		'patch_notes.v1_4.crew2':            'Añadido un botón de nuevo día (-1 moral, +1 salud para todos los tripulantes vivos).',
		'patch_notes.v1_4.crew3':            'Añadido un botón de muerte (-1 moral para todos los tripulantes vivos).',
		'patch_notes.v1_4.crew4':            'Cambiada la moral inicial a 6 en lugar de 14.',
		'patch_notes.v1_4.crew5':            'Corregida la importación de tripulación que no importaba las habilidades mush.',
		'patch_notes.v1_4.crew6':            'Mejorada la ventana de selección de habilidades mush, agrupadas como en la wiki.',
		'patch_notes.v1_4.subtitle_project': 'Gestor de proyectos',
		'patch_notes.v1_4.project1':         'Añadido el módulo de gestión de proyectos.',
		'patch_notes.v1_4.subtitle_general': 'General',
		'patch_notes.v1_4.general1':         'Corregida la extensión que no cargaba correctamente en algunos casos.',
		'patch_notes.v1_4.general2':         'Añadida una forma de reordenar los paneles en los ajustes.',
		'patch_notes.v1_4.general3':         'Ocultar un módulo ahora también oculta sus botones de importación asociados.',
		'patch_notes.v1_4.general4':         'Corregida la pestaña que no se cerraba correctamente.',
		'patch_notes.v1_4.general5':         'Corregidos los botones de importación que a veces aparecían en un mensaje incorrecto y sin relación.',
