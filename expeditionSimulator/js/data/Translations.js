...
const Translations = {
	...
	en: {
		...
		'settings.visibility.hint':           'Click and drag a module to reorganize them.',
		'settings.section.navmode.hover':    'Navigation mode: Hover',
		'settings.section.navmode.click':    'Navigation mode: Click',
		'settings.navmode.hover':            'Hover',
		'settings.navmode.click':            'Click',
		...
		'patch_notes.v1_3.crew1':            'Made group membership (Mush/Human) colorblind accessible.',
		'patch_notes.v1_3.crew2':            'Added a button to collapse the Titles section.',
		'patch_notes.v1_3.crew3':            'Fixed skills not being imported correctly.',
		'patch_notes.v1_3.crew4':            'Added upper bounds to health, morale, spores, AP and days.',
		'patch_notes.v1_3.subtitle_planet':  'Planetary Analyzer',
		'patch_notes.v1_3.planet1':          'The planetary analyzer now saves its state across sessions.',
		'patch_notes.v1_3.planet2':          'Fixed the star rating incorrectly calculating the effect of Diplomacy.',
		'patch_notes.v1_3.planet3':          'Fixed the expedition simulator not re-fetching data from the crew manager on avatar change.',
		'patch_notes.v1_3.planet4':          'The expedition simulation now imports health values from the crew manager.',
		'patch_notes.v1_3.subtitle_settings':'Settings',
		'patch_notes.v1_3.settings1':        'Added click mode: navigate the app by clicking on panels instead of hovering.',
	...
	fr: {
		...
		'settings.visibility.hint':           'Cliquez et glissez un module pour les réorganiser.',
		'settings.section.navmode.hover':    'Mode de navigation : Survol',
		'settings.section.navmode.click':    'Mode de navigation : Clic',
		'settings.navmode.hover':            'Survol',
		'settings.navmode.click':            'Clic',
		'settings.theme.default':            'Beta',
		'settings.theme.retro':              'Aeon\'s Lab',
		...
		'patch_notes.v1_3.crew1':            'L\'appartenance de groupe (Mush/Humain) est maintenant accessible aux daltoniens.',
		'patch_notes.v1_3.crew2':            'Ajout d\'un bouton pour réduire la section des Titres.',
		'patch_notes.v1_3.crew3':            'Correction de l\'import des compétences.',
		'patch_notes.v1_3.crew4':            'Ajout de limites supérieures aux valeurs de santé, moral, spores, PA et jours.',
		'patch_notes.v1_3.subtitle_planet':  'Analyseur planétaire',
		'patch_notes.v1_3.planet1':          'L\'analyseur planétaire sauvegarde maintenant son contenu entre les sessions.',
		'patch_notes.v1_3.planet2':          'Correction du calcul incorrect de l\'effet de la Diplomatie sur les étoiles.',
		'patch_notes.v1_3.planet3':          'Correction du simulateur qui ne récupérait pas les données du manager lors du changement de personnage.',
		'patch_notes.v1_3.planet4':          'La simulation importe maintenant les valeurs de santé depuis le manager.',
		'patch_notes.v1_3.subtitle_settings':'Réglages',
		'patch_notes.v1_3.settings1':        'Ajout d\'un mode clic pour naviguer dans l\'app en cliquant sur les panneaux.',
	...
	es: {
		...
		'settings.visibility.hint':           'Haz clic y arrastra un módulo para reorganizarlos.',
		'settings.section.navmode.hover':    'Modo de navegación: Hover',
		'settings.section.navmode.click':    'Modo de navegación: Clic',
		'settings.navmode.hover':            'Hover',
		'settings.navmode.click':            'Clic',
		'settings.theme.default':            'Beta',
		'settings.theme.retro':              'Aeon\'s Lab',
		...
		'patch_notes.v1_3.crew1':            'El reconocimiento de grupo (Mush/Humano) ahora es accesible para daltonismo.',
		'patch_notes.v1_3.crew2':            'Añadido botón para colapsar la sección de Títulos.',
		'patch_notes.v1_3.crew3':            'Corregida la importación incorrecta de habilidades.',
		'patch_notes.v1_3.crew4':            'Añadidos límites superiores a salud, moral, esporas, PA y días.',
		'patch_notes.v1_3.subtitle_planet':  'Analizador planetario',
		'patch_notes.v1_3.planet1':          'El analizador planetario ahora guarda su contenido entre sesiones.',
		'patch_notes.v1_3.planet2':          'Corregido el cálculo incorrecto del efecto de Diplomacia en las estrellas.',
		'patch_notes.v1_3.planet3':          'Corregido el simulador que no actualizaba datos del manager al cambiar de personaje.',
		'patch_notes.v1_3.planet4':          'La simulación ahora importa los valores de salud del gestor de tripulación.',
		'patch_notes.v1_3.subtitle_settings':'Ajustes',
		'patch_notes.v1_3.settings1':        'Añadido modo clic para navegar haciendo clic en los paneles en lugar de pasar el cursor.',
